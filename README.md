Here, I've analyzed and predicted housing prices given a set of features such as square footage, number of bedrooms, number of floors, etc. using regression algorithms in Machine Learning.
